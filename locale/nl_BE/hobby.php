...
$translated = array(
    ...
    'p3' => 'Ik luister ook veel naar muziek. Niet de mainstream popmuziek die veel te vaak gedraaid
                ...
                en nog vele andere. Het wil niet zeggen dat ik enkel naar die genres luister. Mijn muziekbibliotheek mag dan
                grotendeels uit metal bestaan, er zijn ook andere genres als classic rock, drum&bass, hardstyle, hip hop, etc.',
    'p4' => 'Daarnaast speel ik ondertussen al 11 jaar klassieke en 8 jaar
                elektrische gitaar. De laatste tijd is het vooral de laatste die ik gebruik. Mijn liefde voor de muziekgenres
                die ik hiervoor heb vernoemd, reflecteren zich ook op de nummers die ik op mijn gitaar
    ...
    'p6' => 'Doorheen de jaren heb ik een aantal sporten uitgeoefend. Zo heb ik vijf jaar basketbal
                ...
                feit dat ik het niet meer leuk vond. Die eerste reden woog meestal wel meer door dan die laatste. 
                Aangezien ik het door schoolwerk steeds drukker en drukker kreeg, had ik steeds minder tijd om aan deze
                sporten te besteden. Soms begonnen ze mij ook gewoon tegen te steken. Jammer maar helaas, ik moest ermee ophouden.',
    'p7' => 'Blijven zitten is natuurlijk geen optie, dat is slecht voor mijn conditie. 
                Een tijd geleden besloot ik om er terug aan te werken, mede dankzij mijn lief. Zij was
                begonnen met lopen en ze vroeg of ik misschien ook niet wou meelopen. Ik ging daar natuurlijk op in, aangezien
                mijn conditie al een tijdje redelijk belabberd was. Tegenwoordig is het veel makkelijker om daaraan te beginnen,
                 dankzij de overvloed aan running-apps. Die hebben zowel mij als mijn lief goed geholpen om onze conditie terug
                op een degelijk niveau te krijgen.'
);